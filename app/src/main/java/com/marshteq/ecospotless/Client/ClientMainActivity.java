...
public class ClientMainActivity extends AppCompatActivity
    ...
    private WashRequestAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton wash_request_fab = (FloatingActionButton) findViewById(R.id.wash_request_fab);
        wash_request_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ClientMainActivity.this,WashRequestActivity.class);
        ...
        mLayoutManager = new LinearLayoutManager(ClientMainActivity.this);
...
//        Log.d("Setting9",washRequests.get(0).description);
        mAdapter = new WashRequestAdapter(washRequests,ClientMainActivity.this);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.addItemDecoration(new DividerItemDecoration(ClientMainActivity.this, LinearLayoutManager.VERTICAL));
...
//        progressBar.setVisibility(View.VISIBLE);
        ...
        Credentials credentials = EasyPreference.with(ClientMainActivity.this).getObject("server_details", Credentials.class);
        UserPref pref = EasyPreference.with(ClientMainActivity.this).getObject("user_pref", UserPref.class);
        final String url = credentials.server_url;
        String URL = url+"api/get_current_requests/"+pref.id;
        if(!refreshing){
            progressBar.setVisibility(View.VISIBLE);
        }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            if (back_pressed_count == 1) {
                Toast.makeText(ClientMainActivity.this, "Press Back again to Logout", Toast.LENGTH_SHORT).show();
            } else {
                sp = getSharedPreferences("login", MODE_PRIVATE);
...
//                AppDatabase.destroyInstance();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_logout_client) {
            ...
            startActivity(intent);
        }else if(id == R.id.nav_about_client){
            Intent intent = new Intent(ClientMainActivity.this,AboutEcospotlessActivity.class);
            startActivity(intent);
        }
        else if (id == R.id.nav_help_client) {
            Intent intent = new Intent(ClientMainActivity.this,HelpActivity.class);
            startActivity(intent);
        }
...
//        }
    ...
    public void showLogoutConfirmDialog() {
        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ClientMainActivity.this);
        LayoutInflater inflater = LayoutInflater.from(ClientMainActivity.this);
