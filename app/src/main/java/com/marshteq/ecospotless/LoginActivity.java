...
import com.marshteq.ecospotless.Franchisee.FranchiseeMainActivity;
...
//        populateAutoComplete();
        ...
        Credentials credentials = new Credentials("orbit_shift","https://ecospotless.co.za/");
...
//                                //Log.d("User Years", String.valueOf(prefs.years_experience));
                                ...
                                if (role.equals("app-admin")) {
                                    ...
                                    Intent intent = new Intent(LoginActivity.this, CarValetMainActivity.class);
                                    String image_url = Base_URL + "storage/" +  response.optString("profile_picture_url");
                                    intent.putExtra("profile_picture_url", image_url);
                                    startActivity(intent);
                                }
                            } else {
